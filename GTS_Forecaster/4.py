...
# data
parser.add_argument('--path', type=str, default='../data/9output_filtered.csv', help="文件路径")
...
parser.add_argument('--train_test_ratio', type=float, default=0.1)
parser.add_argument('--random_state', type=int, default=34)
# model
parser.add_argument('--model_name', type=str, default='ConvGRU', help='模型名称选项，LSTM,LSTM_ekan,TCN_ekan,TCN,Transformer,Transformer_ekan,BiLSTM,BiLSTM_ekan,GRU,GRU_ekan,LSTM_Attention，VanillaLSTM，ConvLSTM，CustomLSTM')
...
parser.add_argument('--predict_start', type=int, default=400, help='Start index in original data for prediction')
