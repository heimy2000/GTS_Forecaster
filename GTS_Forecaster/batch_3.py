...
# data
parser.add_argument('--path', type=str, default='../data/agmt_2_filtered.csv', help="文件路径")
...
# model
parser.add_argument('--model_name', type=str, default='BiLSTM', help='模型名称选项，LSTM,LSTM_ekan,TCN_ekan,TCN,Transformer,Transformer_ekan,BiLSTM,BiLSTM_ekan,GRU,GRU_ekan,LSTM_Attention，VanillaLSTM，ConvLSTM，CustomLSTM')
...
if args.vision:
    ...
    plt.xlabel('kalman_value', fontsize=18)
